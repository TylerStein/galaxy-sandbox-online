...
namespace HybridWebSocket
{
    ...
    public class WebSocket : IWebSocket
    {
        ...
        public WebSocket(string url, System.Security.Authentication.SslProtocols sslProtocols)
        {
            ...
            try
            {
                ...
                {
                    Debug.LogWarning("ws.onError " + ev.Message);
                    Debug.LogError(ev.Exception);
    ...
    public static class WebSocketFactory
    {
        ...
        public static WebSocket CreateInstance(string url, System.Security.Authentication.SslProtocols sslProtocols)
        {
#if UNITY_WEBGL && !UNITY_EDITOR
        if (!isInitialized)
            Initialize();
        ...
        return wrapper;
#else
            return new WebSocket(url, sslProtocols);
#endif
        }
